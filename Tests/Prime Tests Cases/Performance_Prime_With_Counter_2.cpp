...
DataStorage dataStorage("Runtime,Scope,CustomCompoundStmt i000002,CXXMemberCallExpr 2873611,CustomCompoundStmt i000004,IfStmt 2876146");
using namespace std;
  ...
  private:
   ...
   public:
      ...
      void printResults(bool showResults, double duration, int passes)
      {
          ...
          ofstream outfile;
          outfile.open("Time_Performance_Prime.txt", ios_base::app);
          outfile << passes << "\n";
